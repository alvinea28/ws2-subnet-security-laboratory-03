...
2. **GitHub:** create your own **Private** copy below, retaining **-laboratory-03** at the end of its name. If you already made a copy, do not copy again.
...
Read the [full setup, all four activities, and recorded simulation outcomes](full-ws-content/README.md). The [public source Exercise #1](https://github.com/alvinea28/ws2-subnet-security-laboratory-03/issues/1) is a **read-only instructor Preview with zero participant progress**, not your learner issue. After copying, follow **your private copy's own README Exercise link**; AgentAlvine updates that same issue body from real work.
