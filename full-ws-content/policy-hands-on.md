...
Complete [setup](../docs/start-here.md) and [Azure setup](../docs/azure-setup.md) with your own
...
1. In your workload clone, create a task branch using [Git help](../docs/git-workflow.md).
...
[cleanup boundary](../docs/azure-setup.md#7-cleanup-privacy-and-returning-to-the-exercise):
